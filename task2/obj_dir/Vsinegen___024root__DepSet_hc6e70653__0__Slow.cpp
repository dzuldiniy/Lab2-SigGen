...
VL_ATTR_COLD void Vsinegen___024root___initial__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    VL_READMEM_N(true, 8, 256, 0, VL_CVT_PACK_STR_NW(3, __Vtemp_ha00c3b92__1)
                 ,  &(vlSelf->sinegen__DOT__cosineRom__DOT__rom_array)
                 , 0, ~0ULL);
}
...
VL_ATTR_COLD void Vsinegen___024root___ctor_var_reset(Vsinegen___024root* vlSelf) {
    ...
    vlSelf->doutsin = VL_RAND_RESET_I(8);
    vlSelf->doutcos = VL_RAND_RESET_I(8);
    vlSelf->sinegen__DOT__addr = VL_RAND_RESET_I(8);
    for (int __Vi0=0; __Vi0<256; ++__Vi0) {
        vlSelf->sinegen__DOT__sineRom__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0=0; __Vi0<256; ++__Vi0) {
        vlSelf->sinegen__DOT__cosineRom__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }
}
